...
export const MODULE_CONTRACTS: readonly ModuleContract[] = [
  ...
  { id: 'contract_admin', landmark: 'Contract Administration sections', firstTab: 'Contracts', role: 'architect', readAssertion: 'Contract', interaction: { target: { kind: 'button', value: 'Variation Orders' }, observable: { kind: 'text', value: 'Variation' } } },
  { id: 'payments_escrow', landmark: 'Payments and Escrow sections', firstTab: 'Payment Workflow', role: 'architect', readAssertion: 'Payment', interaction: { target: { kind: 'button', value: 'Approval & Release' }, observable: { kind: 'text', value: 'Approval' } } },
  ...
  { id: 'contractor_compliance', landmark: 'Contractor Compliance sections', firstTab: 'Compliance Pack', role: 'architect', readAssertion: 'Contractor Compliance', interaction: { target: { kind: 'button', value: 'Document Register' }, observable: { kind: 'text', value: 'Document Register' } } },
  { id: 'site_instructions', landmark: 'Site Instructions sections', firstTab: 'Site Instructions', role: 'architect', readAssertion: 'Site Instructions', interaction: { target: { kind: 'button', value: 'Acknowledgements' }, observable: { kind: 'text', value: 'Acknowledgement' } } },
  { id: 'ncr_manager', landmark: 'NCR Manager sections', firstTab: 'NCR Register', role: 'architect', readAssertion: 'NCR', interaction: { target: { kind: 'button', value: 'Rectification' }, observable: { kind: 'text', value: 'Rectification' } } },
  { id: 'snag_manager', landmark: 'Snag Manager sections', firstTab: 'Snag Register', role: 'architect', readAssertion: 'Snag', interaction: { target: { kind: 'button', value: 'Zones & Walkthroughs' }, observable: { kind: 'text', value: 'Zone' } } },
  { id: 'fm_bridge', landmark: 'FM Bridge sections', firstTab: 'Handover Pack', role: 'architect', readAssertion: 'FM Bridge', interaction: { target: { kind: 'button', value: 'Asset Register' }, observable: { kind: 'text', value: 'Asset Register' } } },
  { id: 'council_navigator', landmark: 'Council Navigator sections', firstTab: 'Council Applications', role: 'architect', readAssertion: 'Council', interaction: { target: { kind: 'button', value: 'Submission Checklist' }, observable: { kind: 'text', value: 'Submission Checklist' } } },
  { id: 'municipal_tracker', landmark: 'Municipal Tracker sections', firstTab: 'Municipal Tracker', role: 'architect', readAssertion: 'Municipal Tracker', interaction: { target: { kind: 'button', value: 'Alerts & Blocks' }, observable: { kind: 'text', value: 'Alerts' } } },
  { id: 'remote_desktop', landmark: 'Remote Desktop sections', firstTab: 'Sessions', role: 'architect', readAssertion: 'Remote Desktop', interaction: { target: { kind: 'button', value: 'Host Machines' }, observable: { kind: 'text', value: 'Host' } } },
  { id: 'cpd_learning', landmark: 'CPD and Learning sections', firstTab: 'CPD Courses', role: 'architect', readAssertion: 'CPD', interaction: { target: { kind: 'button', value: 'SACAP Requirements' }, observable: { kind: 'text', value: 'SACAP' } } },
  { id: 'admin_review', landmark: 'Admin Review sections', firstTab: 'Admin Review', role: 'architect', readAssertion: 'Admin', interaction: { target: { kind: 'button', value: 'System Logs' }, observable: { kind: 'text', value: 'System' } } },
  { id: 'iconography_registry', landmark: 'Iconography Registry sections', firstTab: 'Icon Registry', role: 'architect', readAssertion: 'Icon', interaction: { target: { kind: 'button', value: 'Tone System' }, observable: { kind: 'text', value: 'Tone' } } },
];
