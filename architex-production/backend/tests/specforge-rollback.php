...
$identity = [
    ...
    'role' => 'architect',
    'org' => 'org-demo',
    'projects' => ['proj-faerie-glen'],
    'package_names' => [],
];

$workspaceBefore = $pdo->query("SELECT id,revision FROM specforge_workspaces WHERE organization_id='org-demo' AND project_id='proj-faerie-glen'")->fetch();
...
try {
    $repository->createIssue($identity, 'proj-faerie-glen', ['title' => 'Rollback proof P07', 'audience' => 'Test'], 'rollback-proof-p07');
...
if ($issueCountAfter !== $issueCountBefore || $commandCount !== 0 || $revisionAfter !== 'P07') {
