...
for (const table of ['email_verification_tokens', 'organization_invitations', 'auth_sessions']) {
...
assert.match(sql, /FOREIGN KEY \(user_id\) REFERENCES users\(id\) ON DELETE CASCADE/gi, 'user credentials require cascading ownership');
